...
print(f'*** Database host is: {DATABASE_HOST}')
...
if 'DATABASE_PASSWORD' in os.environ:
    ...
    print(f'*** DB password from env is: {DATABASE_PASSWORD}')
else:
    ps_key = os.environ['ENV_PREFIX'] + 'DATABASE-WEB-USER-PASSWORD'
    print(f'*** ps_key is {ps_key}')
...
print(f'*** DB password is: {DATABASE_PASSWORD}')
